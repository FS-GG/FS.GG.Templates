...
module RealtimeV1 =
    ...
    type PlayerSnapshot =
        { PlayerId: string; Col: int; Row: int }
    ...
    let private encodeInput (v: InputCommand) =
        Encode.object
            [
                ...
                "sequence", Encode.int v.Sequence
                "targetCol", Encode.int v.TargetCol
                "targetRow", Encode.int v.TargetRow
            ]
    ...
    let private encodeSessionHello (v: SessionHello) =
        Encode.object
            [
                "version", Encode.int v.Version
                "sessionCapability", Encode.string v.SessionCapability
            ]
    ...
    let private encodePlayerSnapshot (v: PlayerSnapshot) =
        Encode.object
            [
                "playerId", Encode.string v.PlayerId
                "col", Encode.int v.Col
                "row", Encode.int v.Row
            ]
