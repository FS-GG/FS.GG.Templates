...
let profile =
    {
        ...
        Defaults =
            [
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "w", CommandInput.noModifiers)
                    Command = "game.move-up"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "s", CommandInput.noModifiers)
                    Command = "game.move-down"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "a", CommandInput.noModifiers)
                    Command = "game.move-left"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "d", CommandInput.noModifiers)
                    Command = "game.move-right"
                    Context = "game.play"
                }
#if LEGACY_SVG_PREVIEW
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.PhysicalCode "Space", CommandInput.noModifiers)
                    Command = "game.stop"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "p", CommandInput.noModifiers)
                    Command = "game.pause"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey ".", CommandInput.noModifiers)
                    Command = "game.step"
                    Context = "game.play"
                }
                {
...
#else
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "e", CommandInput.noModifiers)
                    Command = "game.interact"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "r", CommandInput.noModifiers)
...
#endif
                {
                    Gesture = InputGesture.Pointer "move-up"
                    Command = "game.move-up"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "move-down"
                    Command = "game.move-down"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "move-right"
                    Command = "game.move-right"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Touch "move-left"
                    Command = "game.move-left"
                    Context = "game.play"
                }
                {
...
#if LEGACY_SVG_PREVIEW
                {
                    Gesture = InputGesture.Pointer "pause"
                    Command = "game.pause"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "step"
                    Command = "game.step"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "reset"
                    Command = "game.reset"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "win"
                    Command = "game.win"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "lose"
                    Command = "game.lose"
                    Context = "game.play"
                }
#endif
                {
                    Gesture = InputGesture.Pointer "interact"
                    Command = "game.interact"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.Pointer "restart"
                    Command = "game.restart"
                    Context = "game.play"
                }
            ]
...
let profile =
    {
        ...
        Defaults =
            [
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "n", CommandInput.noModifiers)
                    Command = "game.focus-next"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "p", CommandInput.noModifiers)
                    Command = "game.focus-previous"
                    Context = "game.play"
                }
                {
                    Gesture = InputGesture.KeyChord(InputKeyIdentity.LogicalKey "a", CommandInput.noModifiers)
